...
\begin{table}[htbp]
  ...
  \begin{tabular}{llllllllll}
    \toprule
    Dataset & $n_{\text{emb}}$ & $e_{\text{emb}}$ & $h$ & $L$ & Phase enc. & MAE / RMSE (pu) \\
    \midrule
    Original 
        & 12 & 6 & 96 & 3 & none  
        & $0.00583 / 0.00781$ \\
    ...
    Load-type 
        & 16 & 8 & 96 & 2 & none
        & $0.00154 / 0.00214$ \\
    Load-type (phase one-hot) 
        & 16 & 8 & 96 & 2 & one-hot
        & $0.00166 / 0.00241$ \\
    Load-type (per-phase, phase 1) 
        & 16 & 8 & 96 & 2 & subgraph
        & $0.00191 / 0.00257$ \\
    Load-type (per-phase, phase 2) 
        & 16 & 8 & 96 & 2 & subgraph
        & $0.00154 / 0.00210$ \\
    Load-type (per-phase, phase 3) 
        & 16 & 8 & 96 & 2 & subgraph
        & $0.00132 / 0.00201$ \\
    \bottomrule
  \end{tabular}
